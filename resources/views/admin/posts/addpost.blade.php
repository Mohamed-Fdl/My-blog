    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal " method="post" action="{{route('addpost')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="radio" name="category_id" value="{{$category->id}}" id="oui" checked="checked" />
